 ...
 const handleNewsletterSubmit = (e: React.FormEvent) => {
   ...
   if (!email) {
     toast.error("Please enter your email address", {
       style: {
         background: "#ff4d4f", // red error background
   ...
   setTimeout(() => {
     toast.info("Welcome to CuraGenie Newsletter!", {
       description: "You'll receive our latest updates soon.",
       duration: 3000,
       style: {
         background: "#007bff", // blue info background
         color: "#fff",
       },
     });
   }, 1000);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 relative overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 leading-relaxed max-w-2xl">
                ...
                medical platform featuring AI diagnostics, virtual
                consultations, and personalized health insights.
              </p>
            ...
            <div
              className={`relative ${
                isVisible.home ? "animate-fade-in-right" : "opacity-0"
              }`}
              data-animate
            >
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the future of healthcare technology with our
            ...
            {[
              {
                ...
                description:
                  "Advanced machine learning algorithms provide instant health insights and personalized recommendations based on your medical data.",
              ...
              },
              {
                ...
                description:
                  "Continuous health tracking with real-time alerts and comprehensive dashboard visualization for all your vital signs.",
              ...
              },
              {
                ...
                description:
                  "Seamless experience across all devices with responsive design and offline capabilities for healthcare on-the-go.",
              ...
              },
              {
                ...
                title: "Data Security",
                description:
                  "Enterprise-grade encryption and HIPAA-compliant security measures ensure your medical data remains private and secure.",
              ...
              },
              {
                ...
                description:
                  "Connect with healthcare providers, family members, and care teams for comprehensive collaborative health management.",
              ...
              },
              {
                ...
                description:
                  "Tailored health recommendations and treatment plans powered by AI that learns and adapts to your unique health profile.",
              ...
              >
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${feature.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 glow-${feature.glowColor}`}
                >
      ...
      <section
        id="services"
        className="py-32 px-6 bg-gradient-to-b from-slate-900/50 to-transparent relative"
      >
        <div className="container mx-auto">
          <div
            className={`text-center mb-20 ${
            ...
            {[
              {
                ...
                description:
                  "Comprehensive health monitoring and data visualization platform for complete healthcare management.",
                features: [
              ...
              },
              {
                ...
                description:
                  "Advanced artificial intelligence for health data analysis and predictive healthcare insights.",
                features: [
              ...
              },
              {
                ...
                description:
                  "Cross-platform mobile application with responsive design for seamless healthcare access anywhere.",
                features: [
              ...
              <div
                key={index}
                className={`flex flex-col group bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl rounded-3xl p-10 border border-white/10 hover:border-cyan-400/30 transition-all duration-500 hover:scale-105 hover:shadow-2xl glow-subtle ${
                  isVisible.services ? `animate-fade-in-up` : "opacity-0"
                }`}
      ...
      <section id="stats" className="py-32 px-6 relative">
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Trusted by healthcare providers and patients worldwide for
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20">
            {[
              ...
              >
                ...
                <div
                  className="text-4xl font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors duration-300 animate-counter"
          ...
          {/* Developer Section */}
          <div
            className={`bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl rounded-3xl p-12 border border-white/10 max-w-4xl mx-auto text-center glow-subtle ${
              isVisible.stats ? "animate-fade-in-up" : "opacity-0"
            }`}
            data-animate
          ...
          >
            ...
            <p className="text-xl text-cyan-400 mb-6 font-semibold">
              Full Stack Developer & Healthcare Tech Innovator
            </p>

            <p className="text-lg text-gray-300 leading-relaxed mb-8 max-w-2xl mx-auto">
              Passionate about revolutionizing healthcare through cutting-edge
              technology. CuraGenie represents the perfect fusion of AI
              innovation and healthcare accessibility, designed to transform how
              we approach medical care in the digital age.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-8">
              {[
                ...
                <span
                  key={skill}
                  className="px-4 py-2 bg-gradient-to-r from-slate-700 to-slate-800 text-cyan-400 rounded-full text-sm font-semibold border border-cyan-400/20 hover:border-cyan-400/50 transition-all duration-300 hover:scale-105"
                >
                  {skill}
                </span>
              ))}
      ...
      <section
        id="contact"
        className="py-32 px-6 bg-gradient-to-t from-slate-900/50 to-transparent relative"
      >
        <div className="container mx-auto">
          <div
            className={`text-center mb-20 ${
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Ready to revolutionize your healthcare experience? Let's connect
              and explore how CuraGenie can transform your medical journey.
            </p>
          </div>

          {/* Contact Form */}
          <div
            className={`mx-auto max-w-2xl bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl rounded-3xl p-10 border border-white/10 hover:border-cyan-400/30 transition-all duration-500 hover:scale-110 glow-subtle ${
              isVisible.contact ? "animate-fade-in-right" : "opacity-0"
            }`}
            data-animate
            style={{ animationDelay: "0.4s" }}
          >
      ...
      <footer className="py-16 px-6 bg-slate-900/95 backdrop-blur-xl border-t border-white/10 relative">
        <div className="container mx-auto max-w-7xl flex flex-col lg:flex-row justify-between gap-10">
          {/* Logo + Description */}
          <div className="w-full lg:w-1/5 space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              advanced AI tech and <br />
              personalized medicine. <br />
              Built with ❤️ for tomorrow.
            </p>
          </div>
          ...
          <div className="w-full lg:w-1/5">
            ...
            <ul className="space-y-3 text-gray-400">
              <li>
                <a
                  onClick={() => scrollToSection("features")}
                  className="flex items-center space-x-2 hover:text-cyan-400 transition cursor-pointer"
                >
          ...
          <div className="w-full lg:w-1/4 space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              Subscribe to our newsletter for the latest healthcare tech, AI
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-slate-800/50 border border-slate-600/50 rounded-xl text-white placeholder-gray-400 text-sm focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 transition-all duration-300"
                  required
                />
              </div>
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-white font-semibold py-3 rounded-xl transition-all duration-300 hover:scale-105"
              >
        ...
        {/* Bottom Bar */}
        <div className="container mx-auto mt-12 border-t border-slate-700/50 pt-8 flex flex-col md:flex-row items-center justify-between text-gray-500 text-sm">
          <p>
          ...
          <p className="mt-4 md:mt-0">
            Built with React, Next.js, TypeScript & AI/ML
          </p>
        </div>
      </footer>
